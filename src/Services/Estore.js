                ...
                <section class="hero-area bg-1 text-center overly">
	                <div class="container">
		                <div class="row">
					        ...
					        <p>Join the millions who buy on cheep cost  <br></br> 
                            everyday in local communities around the world</p>
					        <div class="short-popular-category-list text-center">
						    <h2>Popular Category</h2>
					        <ul class="list-inline">
							<li class="list-inline-item">
								<a href="category.html"><i class="fa fa-bed"></i> Flour</a></li>
							<li class="list-inline-item">
								<a href="category.html"><i class="fa fa-grav"></i> Rice</a>
							</li>
							<li class="list-inline-item">
								<a href="category.html"><i class="fa fa-car"></i> Cars</a>
							</li>
							<li class="list-inline-item">
								<a href="category.html"><i class="fa fa-cutlery"></i> Fruits</a>
							</li>
							<li class="list-inline-item">
								<a href="category.html"><i class="fa fa-coffee"></i> Vegetables</a>
							</li>
						</ul>
					</div>
                            ...
                            <div class="col-xl-4 col-lg-4 col-sm-12">
                                <div class="product-item bg-light">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <h4 class="card-title"><a href="single.html">Buy Fresh Fruits</a></h4>
                                            ...
                                            <p class="card-text">Join the millions who buy on cheep cost  <br></br> 
                                                everyday in local communities around the world</p>
                            ...
                            <div class="col-xl-4 col-lg-4 col-sm-12">
                                    <div class="product-item bg-light">
                                        <div class="card">
                                            <div class="thumb-content">
                                            <a href="single.html">
                                            <img className="card-img-top img-fluid" src={Rice} alt="Card image cap"/>
                                            </a>
                                            </div>
                                        <div class="card-body">
                                            <h4 class="card-title"><a href="single.html">Buy Rice or Buy raw Rice</a></h4>
                                            <ul class="list-inline product-meta">
                                                <li class="list-inline-item">
                                                    <a href="single.html"><i class="fa fa-folder-open-o"></i>Digital</a>
                                                </li>
                            ...
                            <div class="col-xl-4 col-lg-4 col-sm-12">
                                    <div class="product-item bg-light">
                                        <div class="card">
                                            <div class="thumb-content">
                                            <a href="single.html">
                                            <img className="card-img-top img-fluid" src={Flour} alt="Card image cap"/>
                                            </a>
                                            </div>
                                        <div class="card-body">
